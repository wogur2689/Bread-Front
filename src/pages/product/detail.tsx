...
export default function detail() {
    return (
        <body class="bg-white">
  <!-- 상단 고정 헤더 (스크롤 시 표시) -->
  <header id="stickyHeader" class="sticky-header fixed top-0 left-0 w-full bg-white shadow-md z-50 py-4 px-6">
    <div class="container mx-auto flex justify-between items-center">
      <div class="flex items-center">
        <h1 class="text-lg font-bold">크림 치즈 식빵</h1>
      </div>
      <div class="flex items-center">
        <span class="text-primary font-bold mr-2">4,800원</span>
  ...
  <!-- 메인 컨텐츠 -->
  <div class="container mx-auto px-4 pt-6 pb-24 max-w-6xl">
    <!-- 상단 네비게이션 -->
    ...
    <div class="flex flex-col lg:flex-row gap-8 mb-12">
      ...
      <div class="lg:w-1/2">
        <div class="relative overflow-hidden rounded-lg mb-4">
          <img id="mainImage"
            ...
            alt="크림 치즈 식빵" class="w-full h-auto object-cover rounded-lg" />
          <div class="absolute bottom-4 right-4 bg-white bg-opacity-80 rounded-full p-2 cursor-pointer">
        ...
        <div class="flex space-x-3 overflow-x-auto py-2">
          <div class="thumbnail-active flex-shrink-0 cursor-pointer rounded-md overflow-hidden"
            data-img="https://readdy.ai/api/search-image?query=A%20professional%20food%20photography%20of%20a%20cream%20cheese%20bread%20loaf%2C%20soft%20and%20fluffy%20texture%2C%20with%20visible%20cream%20cheese%20swirls%20inside%2C%20on%20a%20wooden%20cutting%20board%2C%20with%20a%20rustic%20bakery%20background%2C%20warm%20lighting%2C%20high-resolution%2C%20appetizing&width=600&height=600&seq=1&orientation=squarish">
            <img
              src="https://readdy.ai/api/search-image?query=A%20professional%20food%20photography%20of%20a%20cream%20cheese%20bread%20loaf%2C%20soft%20and%20fluffy%20texture%2C%20with%20visible%20cream%20cheese%20swirls%20inside%2C%20on%20a%20wooden%20cutting%20board%2C%20with%20a%20rustic%20bakery%20background%2C%20warm%20lighting%2C%20high-resolution%2C%20appetizing&width=600&height=600&seq=1&orientation=squarish"
              alt="크림 치즈 식빵 썸네일 1" class="w-20 h-20 object-cover" />
          </div>
          <div class="flex-shrink-0 cursor-pointer rounded-md overflow-hidden"
            ...
            <img
              ...
              alt="크림 치즈 식빵 썸네일 2" class="w-20 h-20 object-cover" />
          </div>
          <div class="flex-shrink-0 cursor-pointer rounded-md overflow-hidden"
            ...
            <img
              ...
              alt="크림 치즈 식빵 썸네일 3" class="w-20 h-20 object-cover" />
          </div>
          <div class="flex-shrink-0 cursor-pointer rounded-md overflow-hidden"
            ...
            <img
              ...
              alt="크림 치즈 식빵 썸네일 4" class="w-20 h-20 object-cover" />
          </div>
        </div>
      </div>
      ...
      <!-- 상품 정보 섹션 -->
      <div class="lg:w-1/2">
        <h1 class="text-3xl font-bold mb-2">크림 치즈 식빵</h1>
        ...
        <div class="flex items-center mb-4">
          ...
          <span class="ml-2 text-gray-600">4.7 (132 리뷰)</span>
        </div>

        <div class="mb-6">
          <div class="text-2xl font-bold text-primary mb-1">4,800원</div>
          <div class="text-sm text-gray-500">적립금: 48원 (1%)</div>
        </div>
        ...
        <div class="border-t border-b border-gray-200 py-6 mb-6">
          <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex items-center">
              <button id="decreaseBtn"
                class="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-l-lg">
                <i class="ri-subtract-line"></i>
              </button>
              <input type="number" id="quantity" value="1" min="1"
                class="w-12 h-8 text-center border-t border-b border-gray-300 border-none" readonly />
              <button id="increaseBtn"
                class="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-r-lg">
          ...
          <div class="flex justify-between items-center">
            <span class="text-gray-700">빵 자르기</span>
            <div class="relative">
              <select class="appearance-none bg-white border border-gray-300 rounded py-2 px-4 pr-8">
                <option>선택 안함</option>
                <option>8등분</option>
                <option>16등분</option>
              </select>
        ...
        <div class="flex justify-between items-center mb-6">
          <span class="text-gray-800 font-medium">총 상품 금액</span>
          <div class="text-xl font-bold text-primary">4,800원</div>
        </div>

        <div class="flex space-x-4">
          <button class="w-1/2 border border-primary text-primary py-3 font-medium !rounded-button whitespace-nowrap">
            장바구니 담기
          </button>
          <button class="w-1/2 bg-primary text-white py-3 font-medium !rounded-button whitespace-nowrap">
            바로 구매하기
          </button>
        </div>
      </div>
    ...
    <div class="mb-12">
      <div class="border-b border-gray-200">
        <div class="flex">
          <button class="tab-btn active py-3 px-6 font-medium text-primary border-b-2 border-primary"
            data-tab="details">
            상세정보
          </button>
          <button class="tab-btn py-3 px-6 font-medium text-gray-500" data-tab="reviews">
            리뷰 (132)
          </button>
          <button class="tab-btn py-3 px-6 font-medium text-gray-500" data-tab="qna">
            문의
          </button>
        </div>
      </div>
      ...
      <!-- 상세정보 탭 내용 -->
      <div id="details" class="tab-content py-8">
        <div class="max-w-3xl mx-auto">
          <img
            ...
            alt="크림 치즈 식빵 상세" class="w-full rounded-lg mb-8" />

          <h3 class="text-xl font-bold mb-4">제품 설명</h3>
          <p class="text-gray-700 mb-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              <h3 class="text-lg font-bold mb-3">원재료 정보</h3>
            ...
            <div>
              <h3 class="text-lg font-bold mb-3">알레르기 정보</h3>
              <ul class="text-gray-700 space-y-2">
                <li>• 밀 함유</li>
                <li>• 우유 함유</li>
                <li>• 계란 함유</li>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              <h3 class="text-lg font-bold mb-3">영양 성분 (100g 당)</h3>
              <ul class="text-gray-700 space-y-2">
                <li>• 열량: 295kcal</li>
                <li>• 탄수화물: 42g</li>
                <li>• 단백질: 8g</li>
            ...
            <div>
              <h3 class="text-lg font-bold mb-3">보관 방법</h3>
              <ul class="text-gray-700 space-y-2">
      ...
      <div id="reviews" class="tab-content py-8 hidden">
        <div class="mb-8">
          <div class="flex items-center justify-between mb-6">
            <h3 class="text-xl font-bold">고객 리뷰</h3>
          ...
          <div class="flex items-center mb-6">
            <div class="text-4xl font-bold mr-4">4.7</div>
            <div>
              ...
              <div class="text-gray-500">132개 리뷰 기준</div>
            </div>
          </div>

          <div class="space-y-1 mb-6">
            <div class="flex items-center">
              <span class="w-16 text-sm text-gray-600">5점</span>
              <div class="w-full bg-gray-200 rounded-full h-2.5">
                <div class="bg-yellow-400 h-2.5 rounded-full" style="width: 78%"></div>
              </div>
              <span class="w-12 text-right text-sm text-gray-600">78%</span>
            </div>
            <div class="flex items-center">
              <span class="w-16 text-sm text-gray-600">4점</span>
              <div class="w-full bg-gray-200 rounded-full h-2.5">
                <div class="bg-yellow-400 h-2.5 rounded-full" style="width: 15%"></div>
              </div>
              <span class="w-12 text-right text-sm text-gray-600">15%</span>
            </div>
            <div class="flex items-center">
              <span class="w-16 text-sm text-gray-600">3점</span>
              <div class="w-full bg-gray-200 rounded-full h-2.5">
                <div class="bg-yellow-400 h-2.5 rounded-full" style="width: 5%"></div>
              </div>
              <span class="w-12 text-right text-sm text-gray-600">5%</span>
            </div>
            <div class="flex items-center">
              <span class="w-16 text-sm text-gray-600">2점</span>
              <div class="w-full bg-gray-200 rounded-full h-2.5">
                <div class="bg-yellow-400 h-2.5 rounded-full" style="width: 1%"></div>
              </div>
              <span class="w-12 text-right text-sm text-gray-600">1%</span>
            </div>
            <div class="flex items-center">
              <span class="w-16 text-sm text-gray-600">1점</span>
              <div class="w-full bg-gray-200 rounded-full h-2.5">
                <div class="bg-yellow-400 h-2.5 rounded-full" style="width: 1%"></div>
              </div>
              <span class="w-12 text-right text-sm text-gray-600">1%</span>
          ...
          <div class="border-b border-gray-200 pb-6">
            <div class="flex justify-between mb-2">
              <div class="flex items-center">
                ...
                <span class="font-medium">김민지</span>
              </div>
              <span class="text-gray-500 text-sm">2025-07-01</span>
            </div>
            ...
            <div class="flex space-x-2">
              <img
                ...
                alt="리뷰 이미지" class="w-20 h-20 object-cover rounded" />
              <img
          ...
          <div class="border-b border-gray-200 pb-6">
            <div class="flex justify-between mb-2">
              <div class="flex items-center">
                ...
                <span class="font-medium">박준호</span>
              </div>
              <span class="text-gray-500 text-sm">2025-06-28</span>
            </div>
          ...
          <div class="border-b border-gray-200 pb-6">
            <div class="flex justify-between mb-2">
              <div class="flex items-center">
                ...
                <span class="font-medium">이서연</span>
              </div>
              <span class="text-gray-500 text-sm">2025-06-25</span>
            </div>
            <p class="text-gray-700 mb-3">
      ...
      <!-- 문의 탭 내용 -->
      <div id="qna" class="tab-content py-8 hidden">
        <div class="flex items-center justify-between mb-6">
          <h3 class="text-xl font-bold">상품 문의</h3>
          <button class="bg-primary text-white px-4 py-2 !rounded-button whitespace-nowrap">
            문의하기
          </button>
        </div>
        ...
        <div class="space-y-4">
          <div class="border border-gray-200 rounded-lg overflow-hidden">
            <div class="flex items-center justify-between bg-gray-50 px-6 py-4 cursor-pointer qna-toggle">
              <div class="flex items-center">
                <span class="bg-primary text-white text-xs px-2 py-1 rounded mr-3">답변완료</span>
                <span class="font-medium">유통기한은 얼마나 되나요?</span>
              </div>
              <div class="flex items-center">
                <span class="text-gray-500 text-sm mr-4">최윤서 | 2025-07-02</span>
                <div class="w-6 h-6 flex items-center justify-center">
                  <i class="ri-arrow-down-s-line qna-arrow"></i>
                </div>
              </div>
            </div>
            <div class="px-6 py-4 border-t border-gray-200 hidden qna-content">
              <div class="flex mb-4">
                <span class="text-gray-500 font-medium mr-2">Q.</span>
                <p class="text-gray-700">
                  안녕하세요. 크림치즈 식빵의 유통기한이 궁금합니다. 냉장 보관
                  시와 실온 보관 시 각각 얼마나 되나요?
                </p>
              </div>
              <div class="flex bg-gray-50 p-4 rounded">
                <span class="text-primary font-medium mr-2">A.</span>
                <p class="text-gray-700">
          ...
          <div class="border border-gray-200 rounded-lg overflow-hidden">
            <div class="flex items-center justify-between bg-gray-50 px-6 py-4 cursor-pointer qna-toggle">
              <div class="flex items-center">
                <span class="bg-primary text-white text-xs px-2 py-1 rounded mr-3">답변완료</span>
                <span class="font-medium">빵 자르기 옵션은 어떻게 되나요?</span>
              </div>
              <div class="flex items-center">
                <span class="text-gray-500 text-sm mr-4">정도윤 | 2025-06-30</span>
                <div class="w-6 h-6 flex items-center justify-center">
                  <i class="ri-arrow-down-s-line qna-arrow"></i>
                </div>
              </div>
          ...
          <div class="border border-gray-200 rounded-lg overflow-hidden">
            <div class="flex items-center justify-between bg-gray-50 px-6 py-4 cursor-pointer qna-toggle">
              <div class="flex items-center">
                <span class="bg-gray-500 text-white text-xs px-2 py-1 rounded mr-3">답변대기</span>
                <span class="font-medium">알레르기 정보가 더 자세히 알고 싶어요</span>
              </div>
              <div class="flex items-center">
                <span class="text-gray-500 text-sm mr-4">송지현 | 2025-07-05</span>
                <div class="w-6 h-6 flex items-center justify-center">
                  <i class="ri-arrow-down-s-line qna-arrow"></i>
                </div>
              </div>
    ...
    <!-- 관련 상품 추천 -->
    <div>
      <h3 class="text-2xl font-bold mb-6">함께 구매하면 좋은 상품</h3>
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="border border-gray-100 rounded-lg overflow-hidden shadow-sm">
          <img
            ...
            alt="초코칩 식빵" class="w-full h-48 object-cover" />
          <div class="p-4">
            <h4 class="font-medium mb-1">초코칩 식빵</h4>
            <div class="text-primary font-bold mb-2">4,500원</div>
            <div class="flex text-yellow-400 text-sm">
              ...
              <i class="ri-star-fill"></i>
              <i class="ri-star-half-fill"></i>
              <span class="text-gray-500 ml-1">(98)</span>
            </div>
          </div>
        </div>
        ...
        <div class="border border-gray-100 rounded-lg overflow-hidden shadow-sm">
          <img
            ...
            alt="딸기 잼" class="w-full h-48 object-cover" />
          <div class="p-4">
            <h4 class="font-medium mb-1">홈메이드 딸기 잼</h4>
            <div class="text-primary font-bold mb-2">6,800원</div>
            <div class="flex text-yellow-400 text-sm">
              <i class="ri-star-fill"></i>
              <i class="ri-star-fill"></i>
              <i class="ri-star-fill"></i>
        ...
        <div class="border border-gray-100 rounded-lg overflow-hidden shadow-sm">
          <img
            ...
            alt="통밀 식빵" class="w-full h-48 object-cover" />
          <div class="p-4">
            <h4 class="font-medium mb-1">통밀 건강 식빵</h4>
            <div class="text-primary font-bold mb-2">5,200원</div>
            <div class="flex text-yellow-400 text-sm">
              <i class="ri-star-fill"></i>
              <i class="ri-star-fill"></i>
              <i class="ri-star-fill"></i>
        ...
        <div class="border border-gray-100 rounded-lg overflow-hidden shadow-sm">
          <img
            ...
            alt="프리미엄 버터" class="w-full h-48 object-cover" />
          <div class="p-4">
            <h4 class="font-medium mb-1">프랑스산 발효 버터</h4>
            <div class="text-primary font-bold mb-2">8,900원</div>
            <div class="flex text-yellow-400 text-sm">
              <i class="ri-star-fill"></i>
              <i class="ri-star-fill"></i>
              <i class="ri-star-fill"></i>
  ...
  <!-- 하단 고정 영역 (모바일용) -->
  <div class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 p-4 lg:hidden">
    <div class="flex space-x-4">
      <button class="w-1/2 border border-primary text-primary py-3 font-medium !rounded-button whitespace-nowrap">
        장바구니 담기
      </button>
  ...
  <div id="imageModal" class="fixed inset-0 bg-black bg-opacity-80 z-50 flex items-center justify-center hidden">
    <div class="relative w-full max-w-4xl">
      ...
      <img id="modalImage" src="" alt="확대된 이미지" class="max-w-full max-h-[80vh] mx-auto" />
    </div>
  </div>
    );
}